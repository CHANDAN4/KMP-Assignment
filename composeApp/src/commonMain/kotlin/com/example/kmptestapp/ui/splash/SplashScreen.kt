...
import com.example.kmptestapp.ui.dashboard.navigation.Main
...
@Composable
fun SplashComposeView(navController: NavController) {

    LaunchedEffect(Unit) {
        delay(3000)
        navController.navigate(Main.DashboardScreen.route)
    }
